            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Edit rental id: ${rental.id}</h6>
                    </div>
                    <div class="card-body">
                        <form:form modelAttribute="rental" action="/rental/edit">
                            <form:hidden path="id"/>
                            Tool:
                            <form:select cssClass="form-control" path="tool.id" items="${tools}" itemLabel="name"
                                         itemValue="id"/>
                            User:
                            <form:select cssClass="form-control" path="user.id" items="${users}" itemLabel="lastName"
                                         itemValue="id"/>
                            Rented:
                            <form:input cssClass="form-control" path="rented" type="datetime-local"/>
                            Returned:
                            <form:input cssClass="form-control" path="returned" type="datetime-local"/>
                            Notices:
