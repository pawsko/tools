...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
            ...
            <div id="collapseRental" class="collapse show" aria-labelledby="headingRentals"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Utils:</h6>
                    <a class="collapse-item active" href="/rental/add">Create new rental</a>
                </div>
            </div>
        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form for new rental</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <form:form modelAttribute="rental">
                            ...
                            User:
                            <form:select cssClass="form-control" path="user.id">
                                <form:option value="NONE" label="--- Select ---"/>
                                <c:forEach items="${users}" var="user">
                                    <form:option value="${user.id}">
                                        <c:out
                                                value="${user.id}. ${user.lastName} ${user.firstName}"/>
                                    </form:option>
                                </c:forEach>
                            </form:select>

                            Rented:
                            <form:input cssClass="form-control" path="rented" type="datetime-local"/>
                            <%--    Returned: <form:input path="returned" type="datetime-local"/> <br>--%>
                            Notices:
                            <form:input cssClass="form-control" path="notices"/><br>
