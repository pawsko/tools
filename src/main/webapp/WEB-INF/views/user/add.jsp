...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
            ...
            <div id="collapseUsers" class="collapse show" aria-labelledby="headingUsers"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Utils</h6>
                    <a class="collapse-item active" href="/user/add">Create new user</a>
                </div>
            </div>
        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form for new user</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <form:form modelAttribute="user">
                            ...
                            Phone number:
                            <form:input cssClass="form-control" type="tel" placeholder="123-456-789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}"
                                        path="phoneNumber"/>
                            Email:
                            <form:input cssClass="form-control" type="email" placeholder="email@email.com" path="email"/>
                            Rating:
