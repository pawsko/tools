                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form:form modelAttribute="tool" action="/tool/edit">
                            ...
                            Manufacturer:
                            <form:select cssClass="form-control" path="manufacturer.id" items="${manufacturers}"
                                         itemLabel="nameOfManufacturer"
                                         itemValue="id"/>
                            Category:
                            <form:select cssClass="form-control" path="category.id" items="${categories}"
                            ...
                            Storage location:
                            <form:select cssClass="form-control" path="location.id" items="${locations}"
                                         itemLabel="nameOfLocations"
                                         itemValue="id"/>
                            Created on: ${tool.created}
